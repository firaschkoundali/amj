...
class CreateAdminUserCommand extends Command
{
    ...
    {
        $this
            ->addOption('email', null, InputOption::VALUE_REQUIRED, 'Email de l\'administrateur', 'admin@amj-djerba.tn')
            ->addOption('password', null, InputOption::VALUE_REQUIRED, 'Mot de passe de l\'administrateur', 'admin123')
            ->addOption('nom', null, InputOption::VALUE_OPTIONAL, 'Nom de l\'administrateur', 'Admin')
            ->addOption('prenom', null, InputOption::VALUE_OPTIONAL, 'Prénom de l\'administrateur', 'AMJ')
        ;
    }
